...
Source0  : https://cpan.metacpan.org/authors/id/H/HM/HMBRAND/DBI-1.645.tgz
...
%prep
%setup -q -n DBI-1.645
cd %{_builddir}/DBI-1.645
pushd ..
cp -a DBI-1.645 buildavx2
popd
...
cp %{_builddir}/DBI-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-DBI/21c580608e6208ee1e3500807720ff26cafeec9c || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-DBI/21c580608e6208ee1e3500807720ff26cafeec9c
